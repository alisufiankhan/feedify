const config = {
    ...
    phases: [
        {
            ...
            goalAmount: 50000,
            raised: 1000,
            label: "Current Priority — Help Us Reach 50k in {days} Days",
            items: [
        ...
        },
        {
            ...
            goalAmount: 100000,
            raised: 75000,
            label: "Concluded for this Ramadan — You can donate for iftaar drives or orphans iftaar",
            items: [
            ...
            gallery: [
                { type: "video", url: "assets/phase1video.mp4", poster: "assets/phase1image.jpg" },
                { type: "image", url: "assets/phase1image.png" }
            ]
        }
    ],
    socialProof: {
    ...
    recentDonations: [
        { text: "Someone just donated Rs. 1,000" },
        { text: "Someone donated 1000 for Orphan's iftaar" },
